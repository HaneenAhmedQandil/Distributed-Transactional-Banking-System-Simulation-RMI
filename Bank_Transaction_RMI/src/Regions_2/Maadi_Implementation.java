...
public class Maadi_Implementation extends UnicastRemoteObject implements Maadi_Interface {

    public ArrayList<ClientInfo> clients;
    public MasterServerImp_2 masterServerImp_2;
    Registry registry = LocateRegistry.createRegistry(1003);

    public Maadi_Implementation() throws RemoteException {
        super();
